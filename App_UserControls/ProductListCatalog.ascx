                    ...
                    <div class="col-md-6">
                        ...
                        <div class="productRight product-list-right">
                            <div class="priceInfo product-list-price-info">
                                ...
                                <span class='product-list-price-old percent <%# (ZASutility.MyUtility.SafeEvalNumeric(Container.DataItem, "ref_cena_s_dph")==0 ? 0 : Math.Abs(Math.Ceiling(100 * (Math.Round(ZASutility.MyUtility.SafeEvalNumeric(Container.DataItem, "ref_cena_s_dph"),1)-Math.Round(ZASutility.MyUtility.SafeEvalNumeric(Container.DataItem, "web_items_cena_s_dph"),1)) / Math.Round(ZASutility.MyUtility.SafeEvalNumeric(Container.DataItem, "ref_cena_s_dph"),1)))) < 2 ? " hidden" : "" %>'
